...
|----------------------| -------------|
|Dứt điểm (Shots) | Trong đó các kịch bản với yêu cầu như: ít nhất 1 Tiền vệ hoặc Tiền đạo với kỹ năng dứt điểm hoặc sút xa,….Bao gồm 9 kịch bản . Trong đó các kịch bản với yêu cầu như: ít nhất 1 Tiền vệ hoặc Tiền đạo với kỹ năng dứt điểm hoặc sút xa,…. |
| Tạt bóng (Crosses) | Kịch bản ví dụ như:  ít nhất 1 cầu thủ có khả năng tạt bóng chính xác có thể là tiền vệ hoặc hậu vệ cánh,…. |
| Cắt bóng (Interceptions) | Kịch bản ví dụ: có ít nhất 1 tiền vệ trung tâm có kỹ năng cắt bóng chính xác,… |
| Chuyền bóng (Passes) | Kịch bản VD: có ít nhất 1 hậu vệ có kỹ năng chuyền bóng,… |
